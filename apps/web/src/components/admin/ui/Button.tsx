// apps/web/src/components/admin/ui/Button.tsx
// Admin UI kit button — variants map to design tokens (no hardcoded hex).
// With `to`, renders a react-router Link styled as a button.
import type { ReactNode } from "react";
import { Link } from "react-router";

type ButtonVariant = "primary" | "success" | "danger" | "outline" | "ghost" | "onDark";
